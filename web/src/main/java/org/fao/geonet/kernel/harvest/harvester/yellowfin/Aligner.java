...
public class Aligner extends BaseAligner {
	...
	public YellowfinResult align(Set<RecordInfo> records) throws Exception {
   ...
   * @return metadata the metadata
	...
	{
		try {
			if (log.isDebugEnabled()) log.debug("Getting record (uuid:"+ uuid +")");
			Element response = null;
			try {
				response = request.getRecord(uuid);
			} catch (Exception e) {
				e.printStackTrace();
