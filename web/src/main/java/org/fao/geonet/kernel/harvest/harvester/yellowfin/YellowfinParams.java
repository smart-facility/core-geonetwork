...
public class YellowfinParams extends AbstractParams
{
	//--------------------------------------------------------------------------
	//---
	//--- Constructor
	...
	public YellowfinParams(DataManager dm)
	{
		super(dm);
	}
	...
	public void create(Element node) throws BadInputEx
	{
		...
		hostname = Util.getParam(site, "hostname", "");
		port = Util.getParamAsInt(site, "port");
	...
	public void update(Element node) throws BadInputEx
	{
		...
		if (searches != null) addSearches(searches);
	}
	...
	public YellowfinParams copy()
	{
		YellowfinParams copy = new YellowfinParams(dm);
		copyTo(copy);
