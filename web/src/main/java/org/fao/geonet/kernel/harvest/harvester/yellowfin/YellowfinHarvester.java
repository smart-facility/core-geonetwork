...
public class YellowfinHarvester extends AbstractHarvester
{
	//--------------------------------------------------------------------------
	//---
	//--- Static init
	...
	public String getType() { return "yellowfin"; }
	...
	{
		params = new YellowfinParams(dataMan);
		params.create(node);
	}
	...
	{
		YellowfinParams copy = params.copy();
		...
		//--- we update a copy first because if there is an exception YellowfinParams
	...
	{
		YellowfinParams params = (YellowfinParams) p;

		settingMan.add(dbms, "id:"+siteId, "hostname", params.hostname);
