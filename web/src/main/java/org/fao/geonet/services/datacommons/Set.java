...
public class Set implements Service
{
	...
	public Element exec(Element params, ServiceContext context) throws Exception
	{
   	...
   	//--- call the datamanager routine to run the xslt and write the info
		...
		if (tokens.length != 3) {
				throw new IllegalArgumentException("choice parameter should be of the form licenseurl#imageurl#licensename");
		} 
		String	licenseurl = tokens[0];
		String	imageurl = tokens[1];
		String	licensename = tokens[2];
		dataMan.setDataCommons(dbms,context,id,licenseurl,imageurl,jurisdiction,licensename,type);
