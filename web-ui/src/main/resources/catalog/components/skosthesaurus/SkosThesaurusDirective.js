(function() {
  goog.provide('gn_skos_thesaurus_directive');

  var module = angular.module('gn_skos_thesaurus_directive', []);
   ...
   *
   */
  module.directive('gnSkosThesaurusSelector',
      ['$compile', '$timeout',
       'gnSkosThesaurusService', 'gnEditor',
       ...
       function($compile, $timeout,
         ...
         return {
           ...
           link: function(scope, element, attrs) {
             ...
             // in the record ?
             gnSkosThesaurusService.getAll().then(
   ...
   */
  module.directive('gnSkosKeywordSelector',
      ['$compile', '$timeout',
       'gnSkosThesaurusService', 'gnEditor',
       'Keyword',
       function($compile, $timeout,
               gnSkosThesaurusService, gnEditor, Keyword) {
         ...
         return {
           ...
           templateUrl: '../../catalog/components/skosthesaurus/' +
           'partials/skoskeywordselector.html',
           link: function(scope, element, attrs) {
					 	 $compile(element.contents())(scope); // pick up skos browser
						                                      // directive with compiler

             scope.max = gnSkosThesaurusService.DEFAULT_NUMBER_OF_RESULTS;
             scope.filter = null;
             scope.results = null;
             scope.snippet = null;
             ...
             var init = function() {
               ...
               if (scope.isInitialized) {
                 ...
                 angular.forEach(scope.initialKeywords, function(keyword) {
                   ...
                   gnSkosThesaurusService.getKeywords(keyword,
             ...
             var initTagsInput = function() {
               ...
               $timeout(function() {
                 ...
                 gnSkosThesaurusService.getKeywords('',
                 scope.thesaurusKey, scope.max)
                  .then(function(listOfKeywords) {
                   ...
                   field.typeahead({
                     ...
                     remote: {
                       wildcard: 'QUERY',
                       url: gnSkosThesaurusService.getKeywordsSearchUrl('QUERY',
                       scope.thesaurusKey, scope.max),
                       filter: gnSkosThesaurusService.parseKeywordsResponse
                     },
                     minLength: 0,
                     limit: gnSkosThesaurusService.DEFAULT_NUMBER_OF_SUGGESTIONS
                     // template: '<p>{{label}}</p>'
             ...
             var search = function() {
               gnSkosThesaurusService.getKeywords(scope.filter,
               scope.thesaurusKey, scope.max)
                .then(function(listOfKeywords) {
